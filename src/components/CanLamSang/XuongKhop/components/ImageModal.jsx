    ...
    >
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16 }}>
          {images.map((img, idx) => (
            <div key={idx} style={{ textAlign: 'center', width: 200 }}>
              ...
              />
              <div style={{ fontWeight: 600 }}>{img?.diseases?.name || 'Xương khớp'}</div>
      ...
      <div style={{ marginTop: 16 }}>
        ...
        >
          ...
          <p className="ant-upload-hint">Ảnh sẽ được gán tự động cho BN đang chọn với loại bệnh Xương Khớp</p>
        </Upload.Dragger>
      </div>
    </Modal>
  );
