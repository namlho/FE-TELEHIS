...
export default function AddPatientModal({ open, onCancel, onSubmit, form, loading }) {
  return (
    <Modal title="Thêm bệnh nhân mới" open={open} onCancel={onCancel} footer={null} width={600}>
